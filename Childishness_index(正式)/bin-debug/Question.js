...
var Question = (function (_super) {
    ...
    var d = __define,c=Question,p=c.prototype;
    p.Question = function () {
        var question1 = new egret.Sprite();
        var bg2 = createBitmapByName("2backGround_jpg");
        var musicBtn = createBitmapByName("musicBtn_png");
        var line2 = createBitmapByName("vLine2_png");
        var bt2_1 = createBitmapByName("next2_png");
        var bt2_a = new egret.Bitmap();
        var bt2_b = new egret.Bitmap();
        var bt2_c = new egret.Bitmap();
        var bt2_d = new egret.Bitmap();
        var star2_1 = createBitmapByName("2star1_png");
        var star2_2 = createBitmapByName("2star2_png");
        ...
        if (q1_a == true) {
            bt2_a.texture = RES.getRes("2a2_png");
        }
        else {
            bt2_a.texture = RES.getRes("2A_png");
        }
        if (q1_b == true) {
            bt2_b.texture = RES.getRes("2b2_png");
        }
        else {
            bt2_b.texture = RES.getRes("2B_png");
        }
        if (q1_c == true) {
            bt2_c.texture = RES.getRes("2c2_png");
        }
        else {
            bt2_c.texture = RES.getRes("2C_png");
        }
        if (q1_d == true) {
            bt2_d.texture = RES.getRes("2d2_png");
        }
        else {
            bt2_d.texture = RES.getRes("2D_png");
        }
        ...
        var q2X;
        var question1Change = function (e) {
        ...
        question1.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function (e) {
            q2X = e.stageX;
        }, this);
        ...
        var chooseAnswerStatus = function () {
            if (q1_a == true) {
                bt2_a.texture = RES.getRes("2a2_png");
                if (q1_answer == 1) {
                    right_answer_count = right_answer_count - q1_answer;
                    q1_answer = 0;
                }
            }
            else {
...
egret.registerClass(Question,'Question');
