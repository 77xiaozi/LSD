...
var q4_c;
var q4_d;
var Question4 = (function (_super) {
    __extends(Question4, _super);
    function Question4() {
        _super.call(this);
        this.sprites = [];
        this.Question4();
    }
    var d = __define,c=Question4,p=c.prototype;
    p.Question4 = function () {
        var question4 = new egret.Sprite();
        var bg5 = createBitmapByName("5backGround_jpg");
        var musicBtn = createBitmapByName("musicBtn_png");
        var line5 = createBitmapByName("vLine5_png");
        var bt5_1 = createBitmapByName("back5_png");
        var bt5_2 = createBitmapByName("next5_png");
        var bt5_a = new egret.Bitmap();
        var bt5_b = new egret.Bitmap();
        var bt5_c = new egret.Bitmap();
        var bt5_d = new egret.Bitmap();
        var star5_1 = createBitmapByName("5star1_png");
        var star5_2 = createBitmapByName("5star2_png");
        question4.addChild(bg5);
        question4.addChild(bt5_1);
        question4.addChild(bt5_2);
        this.addChild(question4);
        if (q4_a == true) {
            bt5_a.texture = RES.getRes("5a5_png");
        }
        else {
            bt5_a.texture = RES.getRes("5A_png");
        }
        if (q4_b == true) {
            bt5_b.texture = RES.getRes("5b5_png");
        }
        else {
            bt5_b.texture = RES.getRes("5B_png");
        }
        if (q4_c == true) {
            bt5_c.texture = RES.getRes("5c5_png");
        }
        else {
            bt5_c.texture = RES.getRes("5C_png");
        }
        if (q4_d == true) {
            bt5_d.texture = RES.getRes("5d5_png");
        }
        else {
            bt5_d.texture = RES.getRes("5D_png");
        }
        musicBtn.width = 70;
        musicBtn.height = 70;
        ...
        var q5X;
        var question4Change = function (e) {
        ...
        question4.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function (e) {
            q5X = e.stageX;
        }, this);
        ...
        var chooseAnswerStatus = function () {
            if (q4_a == true) {
                ...
                if (q4_answer == 0) {
                    q4_answer = 1;
                    right_answer_count = right_answer_count + q4_answer;
                }
            }
            else {
                bt5_a.texture = RES.getRes("5A_png");
...
egret.registerClass(Question4,'Question4');
