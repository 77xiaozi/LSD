...
var q6_c;
var q6_d;
var Question6 = (function (_super) {
    __extends(Question6, _super);
    function Question6() {
        _super.call(this);
        this.sprites = [];
        this.Question7();
    }
    var d = __define,c=Question6,p=c.prototype;
    p.Question7 = function () {
        var question6 = new egret.Sprite();
        var line7 = createBitmapByName("vLine7_png");
        var bg7 = createBitmapByName("7backGround_jpg");
        var musicBtn = createBitmapByName("musicBtn_png");
        var bt7_1 = createBitmapByName("back7_png");
        var bt7_2 = createBitmapByName("submit7_png");
        var bt7_a = createBitmapByName("7A_png");
        var bt7_b = createBitmapByName("7B_png");
        var bt7_c = createBitmapByName("7C_png");
        var bt7_d = createBitmapByName("7D_png");
        var star7_1 = createBitmapByName("7star1_png");
        var star7_2 = createBitmapByName("7star2_png");
        question6.addChild(bg7);
        question6.addChild(bt7_1);
        question6.addChild(bt7_2);
        this.addChild(question6);
        if (q6_a == true) {
            bt7_a.texture = RES.getRes("7a7_png");
        }
        else {
            bt7_a.texture = RES.getRes("7A_png");
        }
        if (q6_b == true) {
            bt7_b.texture = RES.getRes("7b7_png");
        }
        else {
            bt7_b.texture = RES.getRes("7B_png");
        }
        if (q6_c == true) {
            bt7_c.texture = RES.getRes("7c7_png");
        }
        else {
            bt7_c.texture = RES.getRes("7C_png");
        }
        if (q6_d == true) {
            bt7_d.texture = RES.getRes("7d7_png");
        }
        else {
            bt7_d.texture = RES.getRes("7D_png");
        }
        musicBtn.width = 70;
        musicBtn.height = 70;
        ...
        var q7X;
        var question6Change = function (e) {
        ...
        question6.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function (e) {
            q7X = e.stageX;
        }, this);
        ...
        var chooseAnswerStatus = function () {
            if (q6_a == true) {
                bt7_a.texture = RES.getRes("7a7_png");
                if (q6_answer == 1) {
                    right_answer_count = right_answer_count - q6_answer;
                    q6_answer = 0;
                }
            }
            else {
...
egret.registerClass(Question6,'Question6');
