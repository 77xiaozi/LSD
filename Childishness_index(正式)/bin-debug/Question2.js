...
var Question2 = (function (_super) {
    ...
    var d = __define,c=Question2,p=c.prototype;
    p.Question2 = function () {
        var question2 = new egret.Sprite();
        var bg3 = createBitmapByName("3backGround_jpg");
        var musicBtn = createBitmapByName("musicBtn_png");
        var line3 = createBitmapByName("vLine3_png");
        var bt3_1 = createBitmapByName("back3_png");
        var bt3_2 = createBitmapByName("next3_png");
        var bt3_a = new egret.Bitmap();
        var bt3_b = new egret.Bitmap();
        var bt3_c = new egret.Bitmap();
        var bt3_d = new egret.Bitmap();
        var star3_1 = createBitmapByName("3star1_png");
        question2.addChild(bg3);
        question2.addChild(bt3_1);
        question2.addChild(bt3_2);
        this.addChild(question2);
        if (q2_a == true) {
            bt3_a.texture = RES.getRes("3a3_png");
        }
        else {
            bt3_a.texture = RES.getRes("3A_png");
        }
        if (q2_b == true) {
            bt3_b.texture = RES.getRes("3b3_png");
        }
        else {
            bt3_b.texture = RES.getRes("3B_png");
        }
        if (q2_c == true) {
            bt3_c.texture = RES.getRes("3c3_png");
        }
        else {
            bt3_c.texture = RES.getRes("3C_png");
        }
        if (q2_d == true) {
            bt3_d.texture = RES.getRes("3d3_png");
        }
        else {
            bt3_d.texture = RES.getRes("3D_png");
        }
        musicBtn.width = 70;
        musicBtn.height = 70;
        ...
        var q3X;
        var question2Change = function (e) {
        ...
        question2.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function (e) {
            q3X = e.stageX;
        }, this);
        ...
        var chooseAnswerStatus = function () {
            if (q2_a == true) {
                bt3_a.texture = RES.getRes("3a3_png");
                if (q2_answer == 1) {
                    right_answer_count = right_answer_count - q2_answer;
                    q2_answer = 0;
                }
            }
            else {
...
egret.registerClass(Question2,'Question2');
