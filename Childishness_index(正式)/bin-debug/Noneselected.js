var Noneselected = (function (_super) {
    __extends(Noneselected, _super);
    function Noneselected() {
        _super.call(this);
        this.sprites = [];
        this.Noneselected();
    }
    var d = __define,c=Noneselected,p=c.prototype;
    p.Noneselected = function () {
        var self = this;
        var noneselected = new egret.Sprite();
        var ns_bg = createBitmapByName("fuzzycontext_jpg");
        var musicBtn = createBitmapByName("musicBtn_png");
        var ns_view = createBitmapByName("notSelect_png");
        var ns_btn = createBitmapByName("ns_subimt_png");
        var ns_q1 = createBitmapByName("Q1_png");
        var ns_q2 = createBitmapByName("Q2_png");
        var ns_q3 = createBitmapByName("Q3_png");
        var ns_q4 = createBitmapByName("Q4_png");
        var ns_q5 = createBitmapByName("Q5_png");
        var ns_q6 = createBitmapByName("Q6_png");
...
egret.registerClass(Noneselected,'Noneselected');
