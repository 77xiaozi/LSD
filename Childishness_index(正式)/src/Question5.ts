...
class Question5 extends egret.DisplayObjectContainer{
	public constructor() {
        super();
        this.Question5();
	}
	...
	private Question5(){
        ...
        //问题5
        var question5: egret.Sprite = new egret.Sprite();
        var line6: egret.Bitmap = createBitmapByName("vLine6_png");
        var bg6: egret.Bitmap = createBitmapByName("6backGround_jpg");
        var musicBtn: egret.Bitmap = createBitmapByName("musicBtn_png");
        var bt6_1: egret.Bitmap = createBitmapByName("back6_png");
        var bt6_2: egret.Bitmap = createBitmapByName("next6_png");
        var bt6_a: egret.Bitmap = new egret.Bitmap();
        var bt6_b: egret.Bitmap = new egret.Bitmap();
        var bt6_c: egret.Bitmap = new egret.Bitmap();
        var bt6_d: egret.Bitmap = new egret.Bitmap();
        var star6_1: egret.Bitmap = createBitmapByName("6star1_png");
        var star6_2: egret.Bitmap = createBitmapByName("6star2_png");
        ...
        //答案的状态
        if(q5_a == true) { bt6_a.texture = RES.getRes("6a6_png"); }
        else { bt6_a.texture = RES.getRes("6A_png"); }
        if(q5_b == true) { bt6_b.texture = RES.getRes("6b6_png"); }
        else { bt6_b.texture = RES.getRes("6B_png"); }
        if(q5_c == true) { bt6_c.texture = RES.getRes("6c6_png"); }
        else { bt6_c.texture = RES.getRes("6C_png"); }
        if(q5_d == true) { bt6_d.texture = RES.getRes("6d6_png"); }
        else { bt6_d.texture = RES.getRes("6D_png"); }
        ...
        var q6X: number;
        var question5Change: Function = function(e: egret.TouchEvent) {
        ...
        question5.addEventListener(egret.TouchEvent.TOUCH_BEGIN,function(e: egret.TouchEvent) {
            q6X = e.stageX;
        },this);
        ...
        var chooseAnswerStatus: Function = function() {
            //答案的状态
            if(q5_a == true) { bt6_a.texture = RES.getRes("6a6_png"); 
                if(q5_answer == 0) { q5_answer = 1; right_answer_count = right_answer_count + q5_answer; }}
            else { bt6_a.texture = RES.getRes("6A_png"); }
            if(q5_b == true) { bt6_b.texture = RES.getRes("6b6_png"); 
                if(q5_answer == 1) { right_answer_count = right_answer_count - q5_answer; q5_answer = 0; }}
            else { bt6_b.texture = RES.getRes("6B_png")}; 
            if(q5_c == true) { bt6_c.texture = RES.getRes("6c6_png"); 
                if(q5_answer == 1) { right_answer_count = right_answer_count - q5_answer; q5_answer = 0; }}
            else { bt6_c.texture = RES.getRes("6C_png"); }
