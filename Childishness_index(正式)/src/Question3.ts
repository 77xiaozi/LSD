...
class Question3 extends egret.DisplayObjectContainer{
	public constructor() {
        super();
        this.Question3();
	}
	...
	private Question3(){
        ...
        //问题3
        var question3: egret.Sprite = new egret.Sprite();
        var bg4: egret.Bitmap = createBitmapByName("4backGround_jpg");
        var musicBtn: egret.Bitmap = createBitmapByName("musicBtn_png");
        var line4: egret.Bitmap = createBitmapByName("vLine4_png");
        var bt4_1: egret.Bitmap = createBitmapByName("back4_png");
        var bt4_2: egret.Bitmap = createBitmapByName("next4_png");
        var bt4_a: egret.Bitmap = new egret.Bitmap();
        var bt4_b: egret.Bitmap = new egret.Bitmap();
        var bt4_c: egret.Bitmap = new egret.Bitmap();
        var bt4_d: egret.Bitmap = new egret.Bitmap();
        var star4_1: egret.Bitmap = createBitmapByName("4star1_png");
        var star4_2: egret.Bitmap = createBitmapByName("4star2_png");
        ...
        //答案的状态
        if(q3_a == true) { bt4_a.texture = RES.getRes("4a4_png"); }
        else { bt4_a.texture = RES.getRes("4A_png"); }
        if(q3_b == true) { bt4_b.texture = RES.getRes("4b4_png"); }
        else { bt4_b.texture = RES.getRes("4B_png"); }
        if(q3_c == true) { bt4_c.texture = RES.getRes("4c4_png"); }
        else { bt4_c.texture = RES.getRes("4C_png"); }
        if(q3_d == true) { bt4_d.texture = RES.getRes("4d4_png"); }
        else { bt4_d.texture = RES.getRes("4D_png"); } 
        ...
        var q4X: number;
        var question3Change: Function = function(e: egret.TouchEvent) {
        ...
        question3.addEventListener(egret.TouchEvent.TOUCH_BEGIN,function(e: egret.TouchEvent) {
            q4X = e.stageX;
        },this);
        ...
        var chooseAnswerStatus: Function = function() {
            //答案的状态
            if(q3_a == true) { bt4_a.texture = RES.getRes("4a4_png"); 
                if(q3_answer == 1) { right_answer_count = right_answer_count - q3_answer; q3_answer = 0; }}
            else { bt4_a.texture = RES.getRes("4A_png"); }
            if(q3_b == true) { bt4_b.texture = RES.getRes("4b4_png"); 
                if(q3_answer == 1) { right_answer_count = right_answer_count - q3_answer; q3_answer = 0; }}
            else { bt4_b.texture = RES.getRes("4B_png"); }
            ...
            if(q3_d == true) { bt4_d.texture = RES.getRes("4d4_png"); 
                if(q3_answer == 0) { q3_answer = 1; right_answer_count = right_answer_count + q3_answer; }}
            else { bt4_d.texture = RES.getRes("4D_png"); } 
        }
	}
}
