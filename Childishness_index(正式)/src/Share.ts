...
class Share extends egret.DisplayObjectContainer{
	...
	private share(){
        var self = this;
        var share: egret.Sprite = new egret.Sprite();
        var share_bg: egret.Bitmap = createBitmapByName("shareBG_jpg"); 
        var star1_1: egret.Bitmap = createBitmapByName("ShareStar1_png");
        var star1_2: egret.Bitmap = createBitmapByName("ShareStar2_png");
        var star1_3: egret.Bitmap = createBitmapByName("ShareStar3_png");
